      ...
      <el-tab-pane :label="$t('trade.orderHistory')">
        ...
        >
          ...
          <el-table-column prop="ordertotal" :label="$t('trade.orderTotal')" width="150">
            <template slot-scope="scope">
              <span>{{ handFloat(NH.times(scope.row.orderPrice, scope.row.orderVol), 4) }} {{ scope.row.code === '3' ? 'BDE' : (scope.row.code === '2' ? ' ETH' : ' EOS') }}</span>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="status" :label="$t('trade.status')" width="100">
            <template slot-scope="scope">
              <span style="color:#808080;">{{ status(scope) }}</span>
            </template>
          </el-table-column>
        </el-table>
      </el-tab-pane>
